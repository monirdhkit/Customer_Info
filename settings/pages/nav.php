<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="/Customer-Info/dashboard.php">Home</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item">
                <a class="nav-link" href="/Customer-Info/add_info.php">Add Info</a>
            </li>
        </ul>
        <ul class="navbar-nav">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <?php endif; ?>
                    <a class="dropdown-item" href="/Customer-Info/logout.php">Logout</a>
                </div>
            </li>
        </ul>
    </div>
